        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="mb-8 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-500">
            <p className="text-lg text-blue-700">
              <strong>Service Notice:</strong> Greetin is provided completely free of charge. No payments or subscriptions are required.
            </p>
          </div>

          <div className="space-y-8">
            {/* Add all the terms of use sections from the HTML file here */}
            {/* Convert each section to JSX format */}
          </div>

          <div className="pt-8 border-t border-blue-200">
            <p className="text-slate-500 text-sm">Effective: December 2024</p>
